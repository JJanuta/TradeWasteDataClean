...
#eplace .. with 0 to prepare for datatype change
df= df.replace('..',"0")
...
#Create a net imports and exports column by subtraction
df['2003']= df['2003 Imports']-df['2003 Exports']
df['2004']= df['2004 Imports']-df['2004 Exports']
df['2005']= df['2005 Imports']-df['2005 Exports']
df['2006']= df['2006 Imports']-df['2006 Exports']
df['2007']= df['2007 Imports']-df['2007 Exports']
df['2008']= df['2008 Imports']-df['2008 Exports']
df['2009']= df['2009 Imports']-df['2009 Exports']
df['2010']= df['2010 Imports']-df['2010 Exports']
df['2011']= df['2011 Imports']-df['2011 Exports']
df['2012']= df['2012 Imports']-df['2012 Exports']
df['2013']= df['2013 Imports']-df['2013 Exports']
df['2014']= df['2014 Imports']-df['2014 Exports']
df['2015']= df['2015 Imports']-df['2015 Exports']
df['2016']= df['2016 Imports']-df['2016 Exports']

df.drop(df.iloc[:,1:29], axis=1, inplace=True)
